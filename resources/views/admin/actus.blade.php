        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-0 mb-lg-10 bg-white ">
                ...
                @if (auth()->check() && auth()->user()->is_admin == 1)
                    ...
                    <li class="nav-item"> <a class="nav-link active" aria-current="page" href="/admin/actus" style="color: #59B0E3">ACTUALITÉS</a> </li>
                @endif
            ...
            <div class="d-flex text-muted pt-3">
                <div class="pb-3 mb-0 small lh-sm border-bottom w-100">
                    <div class="d-flex justify-content-between">
                        <ul>
                            <li><strong class="text-gray-dark">{{ $actu->title }}</strong> </li>
                            <li><strong class="text-gray-dark">{{ $actu->content }}</strong> </li>
                        </ul>
                         <li><img src="{{ $actu->image }}" /></li>
                    </div>
                </div>
            </div>
        @endforeach
